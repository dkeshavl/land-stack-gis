...
export default function LandingPageDark({ onNavigate, toggleTheme }) {
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 md:px-16 py-4 md:py-6 bg-black/50 backdrop-blur-md border-b border-white/10">
        ...
        <div className="flex items-center">
          <button
            ...
            className="text-xl font-bold tracking-[0.2em] uppercase text-white hover:opacity-80 transition-opacity cursor-pointer flex items-center gap-3"
          >
            <img
              src="/logo.jpeg"
              alt="Land Stack Logo"
              className="h-8 w-8 object-contain rounded-md border border-white/20 bg-white shadow-sm"
            />
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="p-2 border border-neutral-700 bg-transparent text-white hover:bg-white/10 transition-colors flex items-center justify-center cursor-pointer"
